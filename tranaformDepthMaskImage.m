function [out_depth_image, out_mask] = tranaformDepthMaskImage(in_depth_image, in_mask, in_cam_mat, in_dist_coef, in_pose, out_cam_mat, out_dist_coef, out_pose, out_shape) %, mask_intel)
% [out_depth_image, out_mask, out_u_e, out_v_e, label_e] 
%TRANAFORMDEPTHIMAGE Summary of this function goes here
%   Detailed explanation goes here
out_mask = zeros(out_shape);
...
%         if in_z == 0
%             in_z = find_closest_depth_image(in_depth_image, j, i, 10);
%         end
...
%             label_temp = mask_intel(j, i);
            ...
            if (out_u >= 0 && ...
                ...
                out_mask(out_v+1, out_u+1) = in_mask(j, i);
